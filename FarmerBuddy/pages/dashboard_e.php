          ...
          <div class="row">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6><?php $db=new Database_api("farmerbuddy");
                            $row = mysqli_fetch_array($db->execute("SELECT COUNT(*) from schemes where uploaded_by=".$_SESSION['uid'].""));
                            echo $row[0];
                       ?></h6>
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Total News</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6><?php $db=new Database_api("farmerbuddy");
                            $row = mysqli_fetch_array($db->execute("SELECT COUNT(*) from news where added_by=".$_SESSION['uid'].""));
                            echo $row[0];
                       ?></h6>
            ...
            <?php
              ...
              $result = $db->getProduction_yyyy("All");
              $xaxis="";
              $yaxis="";
                    ...
                    echo '</div>';
                      ...
                      echo "<div class=\"card-body\">";
                        ...
                        echo "<div id=\"lineChart\" style=\"min-height: 400px;\" class=\"echart\"></div>";
                          ...
                          $m = mysqli_fetch_array($db->execute("SELECT min(yyyy),max(yyyy) from production"));
                          $arr = array();
              ...
              <div class="activity">
                ...
                <?php 
                 ...
                 echo '<tbody>';
                     ...
                     $i=1;
                     $result = $db->execute("SELECT name,email from user where type='Farmer'");
                     while($row = mysqli_fetch_array($result)){
                       echo "<tr>";
                         echo "<th scope='row'><a href='#'>$i</a></th>";
                         echo "<td>$row[0]</td>";
                         echo "<td>$row[1]</td>";
                        //  if($row[1]=="Pending" || $row[1]=="pending")
                        //    echo "<td><span class='badge bg-warning'>$row[2]</span></td>";
                        //  else if($row[1]=="Verified" || $row[1]=="verified")
                        //    echo "<td><span class='badge bg-success'>$row[2]</span></td>";
                        //  else if($row[1]=="Rejected" || $row[1]=="rejected")
                        //    echo "<td><span class='badge bg-danger'>$row[1]</span></td>";
                        //  else 
