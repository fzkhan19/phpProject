...
session_start();
  ...
  if(isset($_POST['submit'])){
    ...
    if(($db->insertUser($name,$email,'User',$address,$phone,$uname,$pass))!= false){
...
<head>
  ...
  <title>Pages / Register - Ewaste Bootstrap Template</title>
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidate method="POST" action="">
                    ...
                    <div class="col-12">
                      <label for="yourEmail" class="form-label">Your Phone no</label>
                      <input type="text" name="phone" class="form-control" id="yourEmail" maxlength="10" minlength="8" required>
