...
(function () {
    ...
    var SetupBehaviourCellState = function (initialState) {
      var init = function () {
        ...
        var set = function (ewastetate) {
          return cell.set(ewastetate);
        };
        var clear = function () {
    ...
    var moveScrollAndTop = function (element, destination, finalTop) {
      return Future.nu(function (callback) {
        ...
        var update = function (ewastecroll) {
          element.dom.scrollTop = ewastecroll;
    ...
    var moveOnlyScroll = function (element, destination) {
      return Future.nu(function (callback) {
        ...
        var update = function (ewastecroll, abort) {
          var previous = safeParse(element, lastScroll);
          if (previous !== element.dom.scrollTop) {
            abort(element.dom.scrollTop);
          } else {
            element.dom.scrollTop = ewastecroll;
            set$8(element, lastScroll, ewastecroll);
          }
        };
        var finish = function () {
          element.dom.scrollTop = destination;
